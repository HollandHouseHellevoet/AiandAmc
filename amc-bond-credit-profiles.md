# AMC Bond Credit Profiles — Top 25 Academic Medical Centers

**Compiled:** April 2, 2026
**Methodology:** Web-sourced public data from Moody's rating actions, S&P Global Ratings disclosures, Becker's Hospital Review, Bond Buyer, EMMA/MSRB filings, and institutional financial reports. All figures cross-referenced where possible. Unverified figures flagged.

---

## Bond Credit Profile Table

Ranked by estimated long-term debt outstanding (descending).
...
| 25 | Ochsner Health | A3 | A | Stable | Not Found | Not Found | Affirmed A3, stable (Moody's); Affirmed A, stable (S&P) |

---

## Summary Statistics

### Institutions Rated Below Aa3 / AA-

**Count: 8 of 25 (32%)**

| Institution | Moody's | S&P | Est. LT Debt ($B) |
|-------------|---------|-----|-------------------|
| UPMC | A2 | A | ~$6.2 |
...
These 8 institutions carry an estimated **$18.8B+** in combined long-term debt at ratings below the Aa3/AA- threshold.

### Institutions on Negative Outlook or Credit Watch

**Count: 1 confirmed, 1 recently stabilized**

- **Emory Healthcare** — Moody's revised Emory University's outlook to **negative** (January 2024), citing "current and expected future weak operating performance stemming largely from Emory Healthcare." System is planning $1B+ in new municipal debt issuance (June 2025) while under negative outlook.
- **WakeMed** — Outlook revised to stable from **negative** (June 2024). Recently stabilized but was on negative watch.
- **Yale New Haven Health** — Downgraded one full notch from Aa3 to A1 (May 2023). Outlook stabilized but downgrade reflects structural operating weakness and elevated debt.

### Aggregate Estimated Long-Term Debt
...
### Macro Credit Environment (2025–2026)

- **Moody's sector outlook:** Stable for 2026, but downgrade-to-upgrade ratio was 2.0:1 in 2024 before moderating to 0.6:1 in 2025. Multi-notch downgrades expected to continue.
- **Fitch median operating margin forecast:** 1%–2% for 2026, below pre-pandemic 2.3% (2019). Sector described as "trifurcated" — top 20% growing, middle 65% stagnating, bottom 15% deteriorating.
- **Drug cost inflation:** +15.2% YoY; supply expenses +13.2%; purchased services +11.7%.
- **Site-neutral payment reform:** CMS finalized 40% OPPS rate for drug administration in off-campus HOPDs, cutting ~$290M in CY2026. Eleven states pursuing facility fee legislation.
- **NIH indirect cost cap:** February 2025 policy capped indirect costs at 15% (down from avg 58%). Court-enjoined but under appeal. If implemented, projected $5.24B annual funding shortfall for research institutions. States with highest exposure: California, New York, Pennsylvania.

### Structural Risk Factors for AMC Debt

1. **Credential scarcity erosion** — AI-augmented diagnostics, robot-assisted surgery, simulation-based training, and remote proctoring decouple physician skill acquisition from physical volume at a single institution. The competitive moat that justified $2B+ surgical tower construction is narrowing.

2. **NIH indirect cost vulnerability** — Institutions modeled for 50–70% recovery rates face margin impairment if the 15% cap survives legal challenge or is partially implemented through legislative compromise.

3. **Site-neutral payment compression** — Facility fee revenue that historically cross-subsidized research and training is under active federal and state legislative attack.

4. **Political protection paradox** — The institutions most exposed sit at the intersection of academic tenure, hospital lobbying, federal grant dependency, and municipal bond markets. Each constituency has structural incentives to suppress acknowledgment of deteriorating fundamentals.

---

## Data Limitations and Flags

- **DSCR (Debt Service Coverage Ratio):** Not publicly available for any of the 25 institutions in web-accessible sources. DSCR is typically disclosed only in official statements filed on EMMA or in continuing disclosure documents behind paywalls. A complete DSCR analysis would require direct EMMA filing review or Bloomberg Terminal access.

- **S&P Ratings:** S&P Global Ratings publishes behind a paywall for most institutions. Only 8 of 25 institutions had publicly confirmable S&P ratings. Remaining marked "Not Found."

- **Debt Figures:** 7 of 25 institutions had no publicly available debt figures in web-accessible sources. Figures marked [UNVERIFIED] are derived from older filings or estimated from rating action reports rather than audited financials.

- **University vs. Hospital Ratings:** Several institutions (U of Michigan, Emory, UCSF) issue debt at the university level rather than the hospital obligated group level. University-level ratings may not reflect hospital-specific credit risk.

- **Operating Margin Data:** Operating margins are sourced from Becker's Hospital Review, Fierce Healthcare, and institutional press releases. Not all institutions disclose operating margin publicly.

---

## Sources

- [Becker's Hospital Review — 28 Health System Rating Downgrades](https://www.beckershospitalreview.com/finance/3-health-system-rating-downgrades/)
- [Kaufman Hall — Five Key Takeaways on Hospital Rating Activity Moderation in 2025](https://www.kaufmanhall.com/insights/blog/five-key-takeaways-hospital-rating-activity-moderation-2025)
- [Fierce Healthcare — Nonprofit Hospital Sector Margin Gains 2026](https://www.fiercehealthcare.com/providers/nonprofit-hospital-sector-notch-modest-margin-gains-2026-systems-tighten-ahead-medicaid)
- [Bond Buyer — NYU Langone Moody's Upgrade to A1](https://www.bondbuyer.com/news/moodys-upgrades-nyu-langone-hospitals-3-2b-revenue-bonds-to-a1)
- [Bond Buyer — Mayo Clinic 2025 Bonds](https://www.bondbuyer.com/news/rochesters-mayo-clinic-bonds-support-broader-expansion)
- [Bond Buyer — Cleveland Clinic Ohio $440M Bonds](https://www.munichain.com/news/ohio-issues-440-million-in-hospital-bonds)
- [UPMC Year End Financial Report December 2025](https://dam.upmc.com/-/media/upmc/about/finances/documents/cy2025-q4-financial-and-operating-report.pdf)
- [UPMC Bond Ratings and Disclosures](https://www.upmc.com/about/finances/disclosures/bond-ratings-disclosures)
- [Stanford Health Care Rating Agencies Information](https://stanfordhealthcare.org/about-us/bondholder-general-financial-information/rating-agencies-information.html)
- [Stanford Health Care 2025 Bonds Official Statement](https://stanfordhealthcare.org/content/dam/SHC/about-us/bondholder-information/docs/2025-bonds-final-os.pdf)
- [Northwell Health Annual Financial Information 2024](https://www.northwell.edu/sites/northwell.edu/files/2025-05/northwell-health-annual-financial-information-2024.pdf)
- [Becker's — Moody's Upgrades Baylor Scott & White to Aa2](https://www.beckershospitalreview.com/finance/moodys-upgrades-baylor-scott-white-healths-rating/)
- [Becker's — Yale New Haven Health Downgraded to A1](https://www.beckershospitalreview.com/finance/yale-new-haven-health-downgraded-to-a1-outlook-revised-to-stable.html)
...
*Working document — bond data sourced from public web-accessible records only.*
*For verified DSCR and complete debt schedules, direct EMMA/MSRB filing review and Bloomberg Terminal access required.*
